// Create a completely new custom dialog component with unique name to avoid conflicts
import * as React from "react"
import { X } from "lucide-react"
import { cn } from "../../components/utils"

// Create custom dialog components using only React hooks
...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => {
  ...
  // This would typically use createPortal, but we're keeping it simple
  return (
